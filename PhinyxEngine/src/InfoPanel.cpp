...
PhinyxEngine::InfoPanel::InfoPanel()
{
...
sf::Text PhinyxEngine::InfoPanel::getSFText()
{
	return m_panelText;
}

sf::RectangleShape PhinyxEngine::InfoPanel::getRect()
{
	return m_panelRect;
}

sf::Vector2f PhinyxEngine::InfoPanel::getPanelSize()
{
	return m_panelRect.getSize();
}

sf::Vector2f PhinyxEngine::InfoPanel::getPanelPosition()
{
	return m_panelPosition;
}

std::string PhinyxEngine::InfoPanel::getTextString()
{
	return m_panelTextString;
}

void PhinyxEngine::InfoPanel::setTextString(std::string textString)
{
	m_panelTextString = textString;
	m_panelText.setString(m_panelTextString);
}

void PhinyxEngine::InfoPanel::setPanelPosition(sf::Vector2f& position)
{
